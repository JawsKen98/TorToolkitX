try:
    ...
    class ExecVars:
        ...
        API_HASH = "5e66609fbfca4190564f209c87b18eaf"
        API_ID = 7243585
        BOT_TOKEN = "2133108062:AAH0qF3cVxtIbyRnElWaGInkF1Z6dr-10K8"
        BASE_URL_OF_BOT = "https://jawsken98ttk.herokuapp.com"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [1735116327, 1835179925]
        OWNER_ID = 1735116327
        
        # Google Drive Index Link should include the base dir also See readme for more info
        GD_INDEX_URL = "https://mirror.kenjaws2gdrive.workers.dev/0:"
        ...
        DB_URI = "dbname=tortk user=jawsken98 password=coolken123 host=db port=5432"
        ...
        DEF_RCLONE_DRIVE = "kenjaws6gdrive"
